...
actually asks --- it is strong: against myopic-control pairs that converge
near competitive play, the audit separates collusive from competitive
mechanisms with \textbf{AUC 0.96}. Off-path audits (reading threat depth
where it lives) and the temporal-precedence question --- does the trigger
structure form \emph{before} prices rise? --- are this paper's designated
next experiments.
\end{abstract}
